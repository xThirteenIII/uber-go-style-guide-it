...
Gli stili sono le convenzioni che governano il nostro codice. Il termine stile
é in realtà usato impropriamente, dal momento che queste convenzioni coprono molto
più della semplice formattazione dei file sorgente-per quello c'é gofmt.

Lo scopo di questa guida é gestire questa complessità descrivendo in dettaglio
le "Cose da fare" e "Cose da non fare" quando si scrive codice Go in Uber. Queste regole
